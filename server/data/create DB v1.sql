create schema if not exists `tracker-trunk-queue`;

use `tracker-trunk-queue`;
...
INSERT INTO user (username, first_name, last_name, passwd) VALUES
    ( 'admin', 'SUPER', 'ADMIN', 'a260aac0b2df3cfdab526689fd1660a3f9871ab17b618e1513812508eb042654'),
    ( 'user1', 'Robin', 'Hood', '8529a401fb906ef05fd89daf4789772fbba71e967ac25cf105476e8057d37030'),
    ( 'user2', 'John', 'Doe', '8529a401fb906ef05fd89daf4789772fbba71e967ac25cf105476e8057d37030')
;
...
INSERT INTO settings (`key`, label, post_input, value_integer, min_value_integer, max_value_integer,value_text) VALUES
    ('t1', 'Tiempo de parpadeo nueva entrada', 'seg.', 10, 1, 60,NULL),
    ('t2', 'Tiempo de visualización de cada página', 'seg.', 20, 1, 300,NULL),
    ('t3', 'Tiempo de duración de la entrada en pantalla. Borrado automático', 'min.', 2, 1, 60,NULL),
    ('t4', 'Tiempo previo de aviso de borrado automático', 'seg.', 30, 0, 60,NULL),
    ('pageSize', 'Número de elementos por página', '', 7, 1, 10,NULL),
